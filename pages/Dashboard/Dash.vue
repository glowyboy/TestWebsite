<template>
  <Navbar/>
   ...
   <div class=" flex lg:gap-20 md:gap-20 xl:gap-20 gap-10  items-center justify-center pt-10">
       <img src="../../assets/images/Platform1.png" class="  sm:w-28 md:w-28 lg:w-28 w-15" >
       <img src="../../assets/images/Platform2.png" class="  sm:w-28 md:w-28 lg:w-28 w-15" >
       <img src="../../assets/images/Platform3.png" class="  sm:w-28 md:w-28 lg:w-28 w-15" > 
       <img src="../../assets/images/Platform4.png" class="  sm:w-28 md:w-28 lg:w-28 w-15" >
       <img src="../../assets/images/Platform5.png" class="  sm:w-28 md:w-28 lg:w-28 w-15" >
    </div>
   <div class="flex lg:flex-row md:flex-row flex-col-reverse px-10 pt-36 gap-10 ">
     
     <div class=" w-full ">
       <img src="../../assets/images/Efficient.png" class="">
     </div>
     <div class="      font-roboto flex items-center justify-center flex-col gap-10  text-btn">
       <p class="font-roboto md:text-6xl lg:text-6xl text-4xl font-bold text-left">Efficient collaboration</p>
       <p class="font-roboto leading-loose text-left lg:text-xl md:text-sm text-base">Mauris consequat, cursus pharetra et, habitasse rhoncus quis odio ac. In et dolor eu donec maecenas nulla. Cum sed orci, sit pellentesque quisque feugiat cras ullamcorper.</p>
     </div>
   </div>
   
   <div class=" grid md:grid-cols-2 lg:grid-cols-2 grid-cols-1 px-10 py-20 gap-10">
     <div class=" flex  justify-center md:items-start lg:items-start items-center flex-col gap-10  text-btn">
       <p class="font-roboto md:text-6xl lg:text-6xl text-4xl font-bold text-left">Work from anywhere</p>
   ...
   <div class=" bg-bl h-80 flex flex-col items-center justify-center text-white gap-10 ">
     <p class="font-roboto md:text-6xl lg:text-6xl text-4xl font-bold text-center ">All the tech & design tools combined</P>
     <p class="font-roboto  lg:text-4xl md:text-4xl text-base text-center">Turpis purus, imperdiet integer amet, eu.</P>
     <button class=" bg-btn cursor-pointer px-7 py-2 rounded-lg text-white font-bold hover:text-btn hover:bg-white hover:border-btn hover:border-2 border-2 border-btn">Request Demo</button>
   </div>
  ...
  <img src="../../assets/images/Desktop.png" class="px-10 relative z-10">
   ...
   <div class=" text-txt grid xl:grid-cols-3 2xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 px-10 gap-10">
     <div class=" flex flex-col items-center justify-center">
       <img src="../../assets/images/watch.png" alt="">
       <p class="font-roboto text-2xl font-bold">Nisl arcu nunc</p>
       <p class="font-roboto text-lg w-96  text-center">Dui consectetur gravida platea ut dis diam. Enim morbi proin auctor et.</p>
     </div>
     <div class=" flex flex-col items-center justify-center">
       <img src="../../assets/images/tourn.png" alt="">
       <p class="font-roboto text-2xl font-bold">Dui scelerisque</p>
       <p class="font-roboto text-lg w-96 text-center">Et sit duis vestibulum proin. Sollicitudin velit, etiam a feugiat sagittis.</p>
     </div>
     <div class="font-roboto flex flex-col items-center justify-center">
       <img src="../../assets/images/three-stars.png" alt="">
       <p class="font-roboto text-2xl font-bold">Ac proin at</p>
       <p class="font-roboto text-lg w-96 text-center">Elit purus magna donec mattis amet, leo varius sed. Ut metus sed convallis.</p>
     </div>
   </div>
     
   <div class=" bg-amber-400 mt-20 grid lg:grid-cols-2 w-full sm:grid-cols-1 md:grid-cols-1 gap-10 ">
     <div class=" flex flex-col items-start  justify-center py-5 px-5 gap-1">
       <p class="font-roboto lg:text-2xl md:text-2xl text-xl text-justify ">Id urna, nisl, ut quam. Diam suspendisse fringilla quam arcu mattis est velit in. Nibh in purus sit convallis phasellus ut. At vel erat ultricies commodo. Neque suspendisse a habitasse commodo.</p>
       <p class="font-roboto w-lg  text-xl text-left">Marie Poirot,</p>
       <p class="font-roboto w-lg  text-xl font-bold text-left">Bigapp</p>
     </div>
     
     <div class=" flex justify-center items-center py-5 ">
       <img src="../../assets/images/Col.png" class=" w-2xs">
     </div>
     
   </div>
   <p class="font-roboto lg:text-6xl md:text-6xl sm:text-5xl text-5xl  text-center font-bold py-20">The features you were looking for</p>

   <div class=" grid xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 p-10 gap-10 text-txt">
    ...
    <div class=" flex flex-col items-centerpy-5 px-5 gap-5">
      ...
      <p>Ullamcorper enim, diam eros sed et vitae sit. Platea porttitor consequat, lorem in arcu et.</p></div>
    </div>
    ...
    <div class=" flex flex-col items-centerpy-5 px-5 gap-5">
      ...
      <p>Blandit ut tortor non, imperdiet. Morbi quam facilisis a nec tortor.</p></div>
    </div>
    ...
    <div class=" flex flex-col items-centerpy-5 px-5 gap-5">
      ...
      <p>Massa mi pharetra viverra risus ornare sit. Viverra tortor, nulla et tellus, nunc.</p></div>
    </div>
    ...
    <div class=" flex flex-col items-centerpy-5 px-5 gap-5">
      ...
      <p>Massa arcu ut id risus et. Neque mauris sagittis cursus tincidunt egestas faucibus amet adipiscing scelerisque.</p></div>
    </div>
    ...
    <div class=" flex flex-col items-centerpy-5 px-5 gap-5">
      ...
      <p>Ullamcorper aliquam maecenas sapien sapien tempus tincidunt urna tempus. Dignissim ut felis a dui a massa risus.</p></div>
    </div>
    ...
    <div class=" flex flex-col items-centerpy-5 px-5 gap-5">
      ...
      <p>Tortor arcu eget nisi neque, in nunc metus. Posuere in egestas pharetra euismod commodo vitae consectetur.</p></div>
    </div>
   </div>
   <p class="font-roboto lg:text-6xl md:text-6xl sm:text-5xl text-5xl  text-center font-bold py-10 px-5">Technology design articles</p>
   <p class="font-roboto lg:text-2xl md:text-2xl sm:text-lg text-lg  text-center pb-10">Felis, semper ullamcorper sed pretium tristique vulputate semper massa ultrices. Integer orci gravida blandit amet.</p>


   <div class=" grid xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-10 px-10 py-10">
   ...
   <p class="font-roboto lg:text-6xl md:text-6xl sm:text-5xl text-5xl  text-center font-bold py-10 px-5">Frequently asked questions</p>

   <div class=" px-10 text-txt py-10">
      <div class=" flex items-center  justify-between py-8 border-t-2 border-gray-300">
        <p>Enim sodales consequat adipiscing facilisis massa venenatis, non lorem lobortis?</p>
        <img src="../../assets/images/down.png" class=" size-6">
      </div>
      <div class=" flex items-center  justify-between py-8 border-t-2 border-gray-300">
        <p>Venenatis nulla sagittis nunc, lobortis nec sollicitudin neque, dolor?</p>
        <img src="../../assets/images/down.png" class=" size-6">
      </div>
      <div class=" flex items-center  justify-between py-8 border-t-2 border-gray-300">
        <p>Varius ultricies molestie tellus fermentum, viverra ipsum scelerisque etiam lorem?</p>
        <img src="../../assets/images/down.png" class=" size-6">
      </div>
      <div class=" flex items-center  justify-between py-8 border-t-2 border-gray-300">
        <p>Nulla etiam vitae, at sagittis, nibh ultrices mattis feugiat faucibus?</p>
        <img src="../../assets/images/down.png" class=" size-6">
      </div>
      <div class=" flex items-center  justify-between py-8 border-t-2 border-gray-300">
        <p>Sagittis consectetur gravida nec turpis eros, id sit et, dictum?</p>
        <img src="../../assets/images/down.png" class=" size-6">
      </div>
   </div>

   <div class=" bg-bg h-80 flex flex-col items-center justify-center text-white gap-10 ">
